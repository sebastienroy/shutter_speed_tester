...
| **Casing** | **Specific design** | A specific casing has to be designed in order to host all the components. There is many differnet ways to design a case. On of them is to model it with a 3D design tool and then to print it using a 3D printer |
