...
The Baby Shutter Tester principles are the same as the open source version ones. However, its design has be reworked in order to be smaller and easier to produce.
