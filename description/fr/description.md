...
Ce type de projet est l'occasion idéale pour un ingénieur de couvrir l'ensemble des phases de réalisation d'un projet, des concepts opérationnels jusqu'à la mise en production. Ceci n'arrive pas souvent dans la vie professionnelle, vu les cycles parfois très longs et la taille des équipes sur lesquels nous sommes impliqués.  
Il pourrait être tentant, vu la taille typique d'un projet personnel et l'absence de contrainte externe, de ne pas formaliser les phases amont, ni même la description des phases de développement successives.  
Ce serait une erreur, car cette formalisation permet de se donner un fil conducteur. C'est une source de satisfaction à chaque étape réalisée. Comme le temps disponible pour le projet est très fragmenté, formaliser chaque étape permet de reprendre les travaux très rapidement après une interruption.
